...
<form action="https://app-37c9113d-6af0-447c-b7e8-acf4bdb4aaa1.cleverapps.io/admin/post/{{$post->id}}" method="post" class="centered login mt-2" enctype="multipart/form-data">
  @method('PUT')
